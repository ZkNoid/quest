...
export const ConnectWallet = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-[47.059vw] lg:!w-[16vw] h-[11.765vw] lg:!h-[4.375vw] rounded-[2.353vw] lg:!rounded-[0.6vw] flex items-center justify-between font-roboto text-[3.765vw] lg:!text-[1.25vw] cursor-pointer group-hover:shadow-none group-hover:font-black",
          dark
            ? "bg-green text-[black] shadow-mainWhite"
            : "bg-[white] shadow-main group-hover:border",
          networkStore.walletConnected
            ? "flex-row-reverse pl-[3.529vw] lg:!pl-[1vw] pr-[3.529vw] lg:!pr-[0.4vw]"
            : "pl-[3.529vw] lg:!pl-[1vw] pr-[1.176vw] lg:!pr-[0.4vw]",
        )}
      >
        <div>
