  ...
  return (
    ...
    >
      ...
      {children ?? (
        <div
          className={cn(
            "pl-[0.25vw] w-[4.125vw] h-[4.125vw] border-white absolute bottom-0 right-0 m-[0.625vw] rounded-[0.6vw] shadow-main border-[0.3125vw] flex items-center justify-center cursor-pointer hover:shadow-xl",
            bg
          )}
        >
          <svg
        ...
        <div className="w-full grid grid-cols-4 h-[34vw] mb-[4.3vw] mt-[2vw]">
          ...
          >
            <div className="flex gap-[1.875vw] pt-[1vw]">
              <div className="w-[4.125vw] h-[4.125vw] bg-white rounded-[0.6vw] shadow-main flex items-center justify-center cursor-pointer hover:shadow-none border-dark hover:border group">
                <svg
                  width="45"
                  height="33"
                  viewBox="0 0 45 33"
