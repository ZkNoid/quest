...
const Dots = () => (
  <svg
    ...
    className="m-[4.235vw] lg:!m-[0.9375vw] w-[6.824vw] lg:!w-[2.5vw]"
  >
    <path
  ...
  return (
    ...
    >
      <div className="w-full text-[9.412vw] lg:!text-[4.3vw]">
        <p>GRAB</p>
        <p>REWARDS</p>
        <div className="w-full flex flex-col lg:!grid lg:!grid-cols-2 lg:!h-[14.9375vw] mb-[4.3vw] mt-[2vw] gap-[3.529vw] lg:!gap-[1.25vw] text-dark relative">
          <div className="absolute z-20 left-0 right-0 ml-auto lg:!mx-auto top-[-14vw] lg:!top-[-6.3vw] w-[23.529vw] lg:!w-[12.659375vw] h-[23.529vw] lg:!h-[12.659375vw]">
            <MotionImage
              src={FlyerMiddle}
              alt=""
              className="absolute w-[23.529vw] lg:!w-[12.659375vw] h-[23.529vw] lg:!h-[12.659375vw]"
              initial={{ rotate: 0 }}
              whileInView={{ rotate: "360deg" }}
              transition={{ duration: 20, ease: "linear", repeat: Infinity }}
            ></MotionImage>
            <div className="absolute text-white text-[5.176vw] lg:!text-[2.786875vw] flex items-center justify-center w-[23.529vw] lg:!w-[12.659375vw] h-[23.529vw] lg:!h-[12.659375vw] text-center leading-none">
              1000 $MINA
            </div>
          </div>
          <div className="bg-green rounded-[2.353vw] lg:!rounded-[0.6vw] flex flex-col justify-center items-center px-[4.235vw] lg:!px-[1.0625vw] py-[7.059vw] lg:!py-0 relative overflow-hidden">
            <Image
              src={DecorationLeft}
              alt=""
          ...
          <div className="bg-violet rounded-[2.353vw] lg:!rounded-[0.6vw] flex flex-col justify-center items-center px-[4.235vw] lg:!px-[1.0625vw] py-[7.059vw] lg:!py-0 relative overflow-hidden">
            ...
            <p className="text-[9.412vw] lg:!text-[4.375vw] z-10">600 $MINA</p>
            <p className="text-[4.235vw] lg:!text-[1.5vw] font-semibold font-roboto z-10 text-center">
      ...
      <div className="my-[15vw] lg:!my-0 w-[100vw] h-[9.412vw] lg:!h-[3.75vw] bg-green text-dark text-[5.176vw] lg:!text-[2vw] relative">
        <ParallaxText baseVelocity={4}>
          <div className="w-[400vw] lg:!w-[200vw] h-full flex items-center absolute pl-10">
